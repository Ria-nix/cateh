...
<div class="navigation">            
    <img src="site/includes/dasha/icons/logo_server.svg" class="logo" alt="logo"  id="main_logo_navigation">
    ...
    <div class="toggle_menu_fon none">
        <div class="toggle_menu border">
            ...
            <span class="button border door exit">                    
                ...
                <img src="site/includes/dasha/icons/exitdoor_87195.svg" alt="alt">
            </span>
        </div>                   
    </div>
