...
<head>
    ...
    <link rel="stylesheet" href="site/pages/order/edit/style.css">
...
<body>
    ...
    <div class="content_wrap">
        <div class="head_order">
            <div class="back_button">
                <button class="button border"><span><img src="site/includes/dasha/icons/restore.svg" alt="restore"></span>Назад</button>
            </div>
            <div class="text">
    ...
    <script src="site/pages/order/edit/script.js"></script>
