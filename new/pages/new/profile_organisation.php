...
<body>
            ...
            <div class="profile">
                <div class="image"> 
                    <div class="logo_organization border">
                        <img src="../includes/icons/logo_server.svg" alt="main logo">
                    </div>
                </div>
                <div class="text"> 
                ...
                <div class="buttons">
                    <button class="button border"><span class="edit"><img src="../includes/icons/edit.svg" alt=""></span><p class="hidden">Редактировать</p></button>
                    <button class="button border"><span class="delete"><img src="../includes/icons//trash 1.svg" alt=""></span><p class="hidden">Удалить</p></button>
                </div>
            </div>
        ...
        <div class="orders">
            <div class="head_table">
                <div class="head_name spacing_special">
                    <p>ФИО <span class="ask_des_arrow"><img src="../includes/icons/up_arrow.svg" alt="arrow" id="arrow"></span></p>
    ...
    <script src="../includes/dasha/v1/modal_windows/modal_windows.js"></script>
