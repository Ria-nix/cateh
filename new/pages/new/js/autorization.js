$(document).ready(function () {
    ...
    $('.button').click(function () {
        ...
        if (log.val() == '' || pass.val() == '') {
            ...
            $.ajax({
                type: "POST",
                url: "https://covidlist.online/site/api/authentication/check/login-or-token",
                data: {
            ...
            // request.open("POST", "https://covidlist.online/site/api/authentication/checck/login-or-token");
