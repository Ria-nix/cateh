    ...
    <div class="content_wrap">
        <div class="head_order">
            <div class="back_button">
                <button class="button border"><span><img src="../includes/icons/restore.svg" alt="restore"></span>Назад</button>
            </div>
            <div class="text">
        ...
        <div class="content_set">
            ...
            <div class="save">
            <button class="button border edit"><span><img src="../includes/icons/edit.svg" alt="edit"></span>Редактировать</button>
                <button class="button border delete"><span><img src="../includes/icons/trash 1.svg" alt="trash"></span>Удалить</button>
            </div>
        </div>
    </div>
