...
<body>
    ...
    <div class="profile_buttons">
        <div class="profile">          
        <p class="role_sysadmin spacing font_20 bold">Администратор</p> 
            <div class="image"> 
            ...
            <div class="text"> 
                <span class="text_info">
                    <p class="spacing font_20">Михаил Куприн</p>
                </span>
        ...
        <div class="competence_list">
            ...
            <!-- <span class="border cell competence_item register">something  something something somethingsomething something</span> -->
            </div>
        </div>
    </div>
    <!-- CONTENT -->
    <div class="content_wrap font_16">
        ...
        <div class="head_table">
            <div class="head_name spacing_special">
                <p>Организация <span class="ask_des_arrow"><img src="icon/up_arrow.svg" alt="arrow" id="arrow"></span></p>
                <p>Выполнено за месяц</p>
                <p>Текущих заказов </p>
            </div>
        </div>
