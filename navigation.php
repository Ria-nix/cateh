...
<div class="navigation">            
    <img src="site/pages/web_ithelpdesk/icon/logo_server.svg" class="logo" alt="logo">
    ...
    <div class="toggle_menu_fon none">
        <div class="toggle_menu border">
            ...
            <span class="button border settings">
                <img src="site/pages/web_ithelpdesk/icon/settings.svg" alt="alt">
                <p class="font_18 icon_none none">Настройки</p>
            </span>
            <span class="button border door exit">                    
                <p class="font_18">Выйти</p>
                <img src="site/pages/web_ithelpdesk/icon/exitdoor_87195.svg" alt="alt">
            </span>
        </div>                   
    </div>
