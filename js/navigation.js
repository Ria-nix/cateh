function transitionMenu(){
    for(let elem of $('.admin')){
        elem.addEventListener('click',function(){window.location.href = 'organization.php';})
    }
    
    for(let elem of $('.admin_plus')){
        elem.addEventListener('click',function(){window.location.href = '#'; })
    }
    ...
    for(let elem of $('.settings')){
        elem.addEventListener('click',function(){window.location.href = 'settings.php'; })
    }
